...
int ssp_XdnsMbi_Initialize(
    void *user_data);

int ssp_XdnsMbi_Finalize(
    void *user_data);

int ssp_XdnsMbi_Buscheck(
    void *user_data);

int ssp_XdnsMbi_GetHealth(
    void);

int ssp_XdnsMbi_FreeResources(
    int priority,
    void *user_data);
...
void ssp_XdnsMbi_WaitConditionReady(
    void *bus_handle,
